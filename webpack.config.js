...
module.exports = {
  ...
  entry: {
    app: [
      ...
      "webpack-dev-server/client?http://0.0.0.0:7001",
  ...
  resolve: {
    modules: [
      'node_modules',
      path.join('node_modules', 'mtd-react', 'site/theme'),
      path.join('node_modules', 'mtd-react', 'utils'),
    ],
    ...
    //   utils: path.join(__dirname, './node_modules', 'mtd-react', 'utils'),
    //   site: path.join(__dirname, './node_modules', 'mtd-react', 'site'),
    // },
  },
  devServer: {
    hot: true,
